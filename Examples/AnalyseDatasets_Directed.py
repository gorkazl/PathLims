...
# Local imports
import pathbounds
from pathbounds.limits import (Pathlen_USdigraph, Pathlen_ULdigraph,
...
assert Reciprocity(net) < 1.0, \
    "Network is Undirected. Use 'AnalyseDatasets_Undirected.py' instead."
...
pathlen_ul = Pathlen_ULdigraph(N,L)

# 2.2) ultra-short efficiency
effic_us = Effic_USdigraph(N,L)
...
effic_ul_disco = Effic_ULdigraph_Disconnected(N,L)
...
plt.axhspan(0, effic_ul_con, facecolor='gold', alpha=0.3)
# Plot the random and lattice
